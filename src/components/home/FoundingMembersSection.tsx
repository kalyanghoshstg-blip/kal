...
export const FOUNDING_MENTORS: MentorProfile[] = [
  ...
  },
  {
    ...
    fullBio: `Dr. Subhashis Mukherjee holds a PhD in Chemistry from IIT Bombay, focusing on synthetic organic chemistry, natural product analogues, and chemoinformatics. He leads spectral validation (1D/2D NMR, HRMS) and rational pharmacophore design across Researcho drug discovery initiatives.`,
    highlights: [
      'PhD in Chemistry from IIT Bombay',
